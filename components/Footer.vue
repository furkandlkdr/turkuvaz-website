<template>
  <footer class="bg-base-200 text-base-content p-8 grid">
    <div class="flex flex-col lg:flex-row gap-10 lg:gap-1 px-6 mx-auto grid lg:grid-cols-4">
      <!-- Company Info -->
      ...
      <div class="max-lg:text-center items-center flex-col">
        ...
        <ul class="space-y-2">
          ...
          <li class="link link-hover flex max-lg:justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 w-5 h-5" viewBox="0 0 512 512">
              <path
                d="M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z" />
            </svg>
            <a href="mailto:info@turkuvazinovasyon.com">E: info@turkuvazinovasyon.com</a>
          </li>
        </ul>
        <!-- Logos -->
