<template>
    ...
    <div>
        <div class="flex">
            <div class="w-2/3 gap-6 p-6 mx-4 my-4 bg-base-200 rounded-lg shadow-lg ">
            ...
            <div class="w-1/3 flex flex-col gap-6 p-6 mr-4 my-4 bg-base-200 rounded-lg shadow-lg">
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        <h1 class="card-title text-3xl text-blue-800">Turkuvaz İnovasyon</h1>
                        <h2 class="text-xl text-blue-600">Sistem Çözümleri A.Ş.</h2>
        ...
        <div>
            <div class="card mx-4 mb-4 bg-base-200 shadow-xl">
                <iframe
                    ...
                    class="w-11/12 h-96 my-8 mx-auto"></iframe>
            </div>
        </div>
